...
if (isset($_GET['delete'])) {
    ...
    // Delete related data from Admin2 table
    ...
    if ($con->query($delete_admin2_sql) === TRUE) {
        ...
        if ($con->query($delete_admin_sql) === TRUE) {
            $_SESSION['delete_success'] = 'true';  // Set session flag for success
        } else {
            $_SESSION['delete_success'] = 'false'; // Set session flag for failure
        }
    } else {
        $_SESSION['delete_success'] = 'false'; // Set session flag for failure
    }
            ...
            <div class="modal-body">
                <form action="addsubmit.php" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" id="price" name="price" class="form-control" required step="0.01"> <!-- Added Bootstrap form-control class -->
                    </div>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js"></script>
        ...
        <div class="toggle-sidebar">
            ...
            <script src="assets/js/jquery-3.7.1.min.js" type="3aab8abce64812a656bcb864-text/javascript"></script>

            <script src="assets/js/bootstrap.bundle.min.js" type="3aab8abce64812a656bcb864-text/javascript"></script>

            <script src="assets/plugins/datatables/datatables.min.js"
                type="3aab8abce64812a656bcb864-text/javascript"></script>
            ...
            <script src="assets/plugins/moment/moment.min.js" type="3aab8abce64812a656bcb864-text/javascript"></script>
            <script src="assets/js/bootstrap-datetimepicker.min.js"
                type="3aab8abce64812a656bcb864-text/javascript"></script>

            <script src="assets/js/jquery-ui.min.js" type="3aab8abce64812a656bcb864-text/javascript"></script>

            <script src="assets/js/theme-settings.js" type="3aab8abce64812a656bcb864-text/javascript"></script>
            <script src="assets/js/greedynav.js" type="3aab8abce64812a656bcb864-text/javascript"></script>

            <script src="assets/js/script.js" type="3aab8abce64812a656bcb864-text/javascript"></script>
            <script src="./cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
                data-cf-settings="3aab8abce64812a656bcb864-|49" defer></script>
...
<script>
  ...
  // Checking for delete success in the URL and showing SweetAlert for delete success
  <?php if (isset($_GET['delete_success']) && $_GET['delete_success'] == 'true') : ?>
    Swal.fire({
      ...
      // Remove 'delete_success' parameter from the URL after showing the alert
      window.history.replaceState(null, null, window.location.pathname);
    });
  <?php endif; ?>

  // Checking for update success in the URL and showing SweetAlert for update success
...
<script>
    <?php if (isset($_GET['delete_success'])): ?>
        <?php if ($_GET['delete_success'] == 'true'): ?>
            Swal.fire({
                title: 'Deleted!',
                text: 'The record has been deleted successfully.',
                icon: 'success',
        ...
        <?php elseif ($_GET['delete_success'] == 'false' && isset($_GET['error'])): ?>
            Swal.fire({
                title: 'Error!',
                text: 'An error occurred: <?php echo htmlspecialchars($_GET['error'], ENT_QUOTES, 'UTF-8'); ?>',
                icon: 'error',
                confirmButtonColor: '#d33',
                confirmButtonText: 'OK'
            });
