...
// Fetch the maximum quotation number from the Admin table, treating it as an integer
$result = $con->query("SELECT MAX(CAST(SUBSTRING(`quotation No`, 3) AS UNSIGNED)) AS maxQuotationNo FROM `Admin`");
$row = $result->fetch_assoc();

// Set the quotation number based on your logic
if ($row['maxQuotationNo'] !== null) {
    ...
    $quotationNo = 1;  // Start from 1 if there are no records
}

// Format the quotation number with a prefix "IA" and zero-padding
                                                        ...
                                                        <table id="AdminTable"
                                                            ...
                                                            <tbody id="AdminTableBody">
                                                                <tr>
                                                                    ...
                                                                    <td><button type="button" class="btn btn-primary" onclick="removeRow(this)">
                                                                        <i class="fa fa-trash" style="border:none; background:none;"></i> </button>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
...
function addNewRow() {
    ...
    newRow.innerHTML = `
        ...
        <td><input type="number" name="qty${sno}" class="form-control" oninput="calculateTotal()" required></td>
        <td><input type="number" name="total${sno}" class="form-control" required oninput="trackManualTotal(this);" required></td>
...
<!-- <script src="assets/js/jquery-3.7.1.min.js" type="da4f9371b8a44478d6db867d-text/javascript"></script> -->
