...
if ($id > 0) {
    // Fetch quotation data from Admin table
    ...
    if ($result->num_rows > 0) {
        ...
        // Fetch related items from Admin2 table
        ...
        // Calculate subtotal and overall total
        foreach ($admin2Data as $item) {
            $subtotal += $item['total']; // Sum up the total of each item
            // Assuming overall total is the same as subtotal; adjust as needed
